...
<section class="page-banner bg_cover" style="background-image: url(<?= get_picture("settings_v", $settings->blog_logo) ?>);">
    <div class="container">
        <div class="page-banner-content text-center">
            <h2 class="title"><?= strto("lower|upper", lang("blog")); ?></h2>
                    ...
                    <div class="col-lg-8">
                        <div class="single-blog mt-80">
                            ...
                            <div class="blog-content">
                                ...
                                <h4 class="title"><a class="title" rel="dofollow" href="<?= base_url(lang("routes_blog") . "/" . lang("routes_blog_detail") . "/{$value->seo_url}") ?>" title="<?= $value->title ?>"><?= $value->title ?></a></h4>
                                <ul class="blog-meta">
                                    <li><a href="javascript:void(0)"><i class="bx bx-time"></i> <?= iconv("ISO-8859-9", "UTF-8", strftime("%d %B %Y, %A %X", strtotime($value->updatedAt))); ?></a></li>
                                </ul>
                                <p><?= mb_word_wrap($value->content, 500, "...") ?></p>
                                <a class="main-btn" rel="dofollow" href="<?= base_url(lang("routes_blog") . "/" . lang("routes_blog_detail") . "/{$value->seo_url}") ?>" title="<?= $value->title ?>"><?= lang("viewBlog") ?></a>
                            </div>
                        </div>
                ...
                <div class="blog-sidebar">
                    <div class="blog-sidebar-search mt-80">
                        ...
                        <div class="sidebar-search-form">
                            ...
                            <form class="d-flex" action="<?= !empty($this->uri->segment(3) && !is_numeric($this->uri->segment(3))) ? base_url(lang("routes_blog") . "/" . $this->uri->segment(3)) : base_url(lang("routes_blog")) ?>" method="GET" enctype="multipart/form-data">
                    ...
                    <div class="blog-sidebar-category mt-50">
                        <h4 class="sidebar-title"><?= lang("blogCategories") ?></h4>
                        <hr>
                    ...
                    <?php if (!empty($latestBlog)) : ?>
                        <div class="blog-sidebar-post mt-50">
                            <h4 class="sidebar-title"><?= lang("latestBlog") ?></h4>
                            <hr>
                                    ...
                                    <div class="sidebar-post">
                                        <div class="single-post">
                                            <div class="post-thumb">
                                                <a href="<?= base_url(lang("routes_blog") . "/" . lang("routes_blog_detail") . "/{$value->seo_url}") ?>"> <img width="1920" height="1280" loading="lazy" data-src="<?= get_picture("blogs_v", $value->img_url) ?>" alt="<?= $value->title ?>" class="lazyload img-fluid" width="150" height="150">
                                                </a>
                                            </div>
                                            <div class="post-content">
                                                <h6 class="title"><a rel="dofollow" href="<?= base_url(lang("routes_blog") . "/" . lang("routes_blog_detail") . "/{$value->seo_url}") ?>" title="<?= $value->title ?>"><?= $value->title ?></a></h6>
