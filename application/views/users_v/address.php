...
<form id="createAddress" onsubmit="return false" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group mb-3">
        <button aria-label="<?=$settings->company_name?>" role="button" class="common-btn btnSave btn w-100 rounded-0" data-url="<?= asset_url("home/new_address") ?>" style="color:white;"><?= lang("saveAddressInformation") ?></button>
    </div>
