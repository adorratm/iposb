...
<form id="updateAddress" onsubmit="return false" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group mb-3">
        <button aria-label="<?=$settings->company_name?>" role="button" class="btn w-100 common-btn btnUpdate rounded-0" data-url="<?= asset_url("home/update_address/{$item->id}") ?>"><?= lang("updateAddressInformation") ?>
        </button>
    </div>
</form>
<script>
