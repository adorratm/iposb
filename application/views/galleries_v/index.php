                    ...
                    <?php if (strtotime($value->sharedAt) <= strtotime("now")) : ?>
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="single-collection">
                                ...
                                <a class="read-more-btn icon-space-left text-center" rel="dofollow" href="<?= base_url(lang("routes_galleries") . "/" . lang("routes_gallery") . "/{$value->url}") ?>" title="<?= $value->title ?>"><?= lang("viewGallery") ?> <i class="bx bx-chevron-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    <?php endif ?>
                <?php endforeach ?>
