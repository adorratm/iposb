                            ...
                            <?php if (!empty($product)) : ?>
                                <tr>
                                    <td class='text-center align-middle justify-content-center mx-auto px-auto'>
                                        <img class='img-fluid' src='<?= get_picture("products_v", $product->img_url) ?>' style='max-width:150px;max-height:150px;' width="150" height="150">
                                    </td>
                                    ...
                                    <td class='text-center align-middle justify-content-center mx-auto px-auto'><?= $cart_value["price"] ?> <?=$symbol?></td>
                                    <td class='text-center align-middle justify-content-center mx-auto px-auto'><?= $cart_value["subtotal"] ?> <?= $symbol ?></td>
                                </tr>
                            <?php endif ?>
                        <?php endforeach ?>
                    </tbody>
