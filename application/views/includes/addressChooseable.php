        ...
        <address class="mb-3 border p-3">
            ...
            <div class="d-flex flex-wrap align-items-center align-self-center">
                <div class="flex-grow-1 pe-3">
                    <a rel="dofollow" data-url="<?= asset_url("home/editAddressForm/{$value->id}") ?>" href="javascript:void(0)" class="btn border w-100 p-3 mb-3 mb-lg-0 mb-xl-0 editAddressBtn" title="<?= lang("addressEdit") ?>"><i class="bx bx-edit"></i> <?= lang("addressEdit") ?></a>
                </div>
                <div class="flex-grow-1 pe-3">
                    <button aria-label="<?=$settings->company_name?>" data-url="<?= asset_url("home/delete_address/{$value->id}") ?>" class="btn w-100 border p-3 mb-3 mb-lg-0 mb-xl-0 deleteAddress"><i class="bx bx-trash"></i> <?= lang("addressDelete") ?></button>
                </div>
