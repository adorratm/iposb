...
<section class="page-banner bg_cover" style="background-image: url(<?= get_picture("settings_v", $settings->service_logo) ?>);">
    <div class="container">
        <div class="page-banner-content text-center">
            <h2 class="title"><?= strto("lower|upper", lang("service")); ?></h2>
                    ...
                    <div class="col-lg-8">
                        <div class="single-blog mt-80">
                            ...
                            <div class="blog-content">
                                ...
                                <ul class="blog-meta">
                                    <li><a href="javascript:void(0)"><i class="bx bx-time"></i> <?= $dateFormatter->format(new Datetime($value->updatedAt)); ?></a></li>
                                </ul>
