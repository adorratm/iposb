...
class Testimonial_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'content', 'full_name','lang', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'content', 'full_name','lang', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
