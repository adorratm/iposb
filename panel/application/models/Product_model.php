...
class Product_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->column_order = ['rank', 'id', 'id', 'title', 'price','company_code', 'isNew', 'isSuggested', 'isDiscount', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set searchable column fields
        $this->column_search = ['rank', 'id', 'id', 'title', 'price','company_code', 'isNew', 'isSuggested', 'isDiscount', 'isActive', 'createdAt', 'updatedAt', 'sharedAt'];
        // Set default order
        $this->order = ['rank' => 'ASC'];
    }
