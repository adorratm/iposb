...
class Service_categories extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $viewData->items = $this->service_category_model->get_all();
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"]) :
            ...
            echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Bölüm Kategorisi Kaydı Yapılırken Hata Oluştu. \"{$key}\" Bilgisini Doldurduğunuzdan Emin Olup Tekrar Deneyin."]);
        else :
            $getRank = $this->service_category_model->rowCount();
            $data["seo_url"] = seo($data["title"]);
            $data["isActive"] = 1;
            $data["rank"] = $getRank + 1;
            $insert = $this->service_category_model->add($data);
            if ($insert) :
                echo json_encode(["success" => true, "title" => "Başarılı!", "message" => "Bölüm Kategorisi Başarıyla Eklendi."]);
            else :
                echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Bölüm Kategorisi Eklenirken Hata Oluştu, Lütfen Tekrar Deneyin."]);
            endif;
        endif;
    }
    ...
    public function update($id)
    {
        ...
        if (checkEmpty($data)["error"]) :
            $key = checkEmpty($data)["key"];
            echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Bölüm Kategorisi Güncelleştirilirken Hata Oluştu. \"{$key}\" Bilgisini Doldurduğunuzdan Emin Olup Tekrar Deneyin."]);
        else :
            ...
            if (!empty($_FILES["img_url"]["name"])) :
                ...
                if ($image["success"]) :
                    ...
                    echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Bölüm Kategorisi Güncelleştirilirken Hata Oluştu. Bölüm Kategorisi Görseli Seçtiğinizden Emin Olup Tekrar Deneyin."]);
                    die();
                endif;
            endif;
            $data["seo_url"] = seo($data["title"]);
            ...
            if ($update) :
                echo json_encode(["success" => true, "title" => "Başarılı!", "message" => "Bölüm Kategorisi Başarıyla Güncelleştirildi."]);
            else :
                echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Bölüm Kategorisi Güncelleştirilirken Hata Oluştu, Lütfen Tekrar Deneyin."]);
            endif;
        endif;
    }
    public function delete($id)
    {
        ...
        if (!empty($service_category)) :
            ...
            if ($delete) :
                ...
                echo json_encode(["success" => true, "title" => "Başarılı!", "message" => "Bölüm Kategorisi Başarıyla Silindi."]);
            else :
                echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Bölüm Kategorisi Silinirken Hata Oluştu, Lütfen Tekrar Deneyin."]);
            endif;
        endif;
    }
