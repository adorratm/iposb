...
class Product_variations extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $items = $this->product_variation_model->get_all();
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"] && checkEmpty($data)["key"] != "top_id" && checkEmpty($data)["key"] != "price") :
            ...
            $getRank = $this->product_variation_model->rowCount();
            $data["isActive"] = 1;
            $data["rank"] = $getRank + 1;
    ...
    public function update_form($id)
    {
        ...
        $viewData->item = $this->product_variation_model->get(["id" => $id]);
        $viewData->settings = $this->general_model->get_all("settings", null, null, ["isActive" => 1]);
        $this->load->view("{$viewData->viewFolder}/{$viewData->subViewFolder}/content", $viewData);
    }
    ...
    {
        $product_variation_category = $this->product_variation_model->get(["id" => $id]);
