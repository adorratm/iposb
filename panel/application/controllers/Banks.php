...
class Banks extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $items = $this->bank_model->get_all([], "rank ASC");
    ...
    {
        $items = $this->bank_model->getRows([], $_POST);
        $data = [];
        ...
        $output = [
            ...
            "recordsTotal" => $this->bank_model->rowCount(),
            "recordsFiltered" => $this->bank_model->countFiltered([], (!empty($_POST) ? $_POST : [])),
            "data" => $data,
        ];
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"]) :
            ...
            $getRank = $this->bank_model->rowCount();
            if (!empty($_FILES)) :
