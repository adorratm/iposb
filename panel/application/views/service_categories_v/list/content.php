...
<script>
    $(document).ready(function() {
        $(document).on("click", ".createServiceCategoryBtn", function(e) {
            ...
            createModal("#serviceCategoryModal", "Yeni Bölüm Kategorisi Ekle", "Yeni Bölüm Kategorisi Ekle", 600, true, "20px", 0, "#e20e17", "#fff", 1040, function() {
        ...
        $(document).on("click", ".updateServiceCategoryBtn", function(e) {
            ...
            $('#serviceCategoryModal').iziModal('destroy');
            let url = $(this).data("url");
            createModal("#serviceCategoryModal", "Bölüm Kategorisi Düzenle", "Bölüm Kategorisi Düzenle", 600, true, "20px", 0, "#e20e17", "#fff", 1040, function() {
                $.post(url, {}, function(response) {
                    $("#serviceCategoryModal .iziModal-content").html(response);
                    TinyMCEInit();
                    flatPickrInit();
