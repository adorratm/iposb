...
<form id="createProduct" onsubmit="return false" action="" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                <label>Dış URL</label>
                <input class="form-control form-control-sm rounded-0" placeholder="Dış URL" name="external_url" required>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="form-group">
                ...
                <input type="text" name="company_code" class="form-control form-control-sm rounded-0" placeholder="Firma Kodu">
            </div>
        </div>
    </div>
    <div class="row">
